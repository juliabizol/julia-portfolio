      ...
      <div className="mx-auto max-w-[1440px] px-5 md:px-10 lg:px-20 pb-20 md:pb-28 lg:pb-32">
        <div className="flex flex-col lg:flex-row items-start lg:items-center gap-10 lg:gap-20">
          ...
          <div className="flex flex-1 flex-col gap-6 md:gap-7">
            ...
            <Link
              href="/about"
              className="inline-flex items-center gap-1 py-0.5 -my-0.5 text-[14px] font-medium text-purple-300 hover:text-white active:text-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-purple-400 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950"
            >
              Learn more about me →
            </Link>
          </div>
